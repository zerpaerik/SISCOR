  ...
  <div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
      ...
      <form role="form" action="{{asset('correspondencia/responderasignadasCorrespondencia')}}/{{$correspondencia->id}}" id="responderasignadasCorrespondencia">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Responder Correspondencia Asignada</h4>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button href="{{asset('correspondencia/responderasignadasCorrespondencia')}}/{{$correspondencia->id}}" 
          ...
          swal({
              ...
              function(){
                    //ajax que hace la peticion por get a la url
                           ...
                           $("#responderasignadasCorrespondencia").submit();
