  ...
  <div class="modal fade" id="myModal3" role="dialog">
    <div class="modal-dialog">
      ...
      <form role="form" action="{{asset('correspondencia/responderrechazadasCorrespondencia')}}/{{$correspondencia->id}}" id="responderCorrespondenciaRechazada">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Responder Correspondencia Rechazada</h4>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button href="{{asset('correspondencia/responderrechazadasCorrespondencia')}}/{{$correspondencia->id}}" 
          ...
          swal({
              ...
              function(){
                    //ajax que hace la peticion por get a la url
                           ...
                           $("#responderCorrespondenciaRechazada").submit();
