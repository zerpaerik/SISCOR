	...
	<div id="paginacion">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<div class="col s6">
					<b>Correspondencias Rechazadas</b>
				</div>			
				<div class="input-field col s6">
                  @include('correspondencia.bandejas.rechazadas.search')
				</div>
				</div>
				<table class="table">
					<thead>
					...
					@foreach($data as $correspondencia)
						<tr>
							...
							<td>{{date("d-m-Y g:i A",strtotime($correspondencia->fecha_recepcion))}}</td>
							 ...
							 <td>
                                <input type="button"
                                       class=" waves-effect waves-light btn verRechazadas"
                                       href="{{asset('/correspondencia/verRechazadas')}}/{{$correspondencia->id_correspondencia}}"  
                                       value="Ver"/>
                            </td>
