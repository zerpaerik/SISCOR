   <div class="row">
            ...
            <form role="form" id="create" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="descripcion" name="descripcion"
                    placeholder="Introduzca el nombre de la dirección" required autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="siglas">Siglas de Direccion</label>
                  <input type="text" class="form-control" id="siglas" name="siglas"
                    placeholder="Introduzca las siglas de la dirección" required autocomplete="off">
                </div>
    ...
    <script type="text/javascript">
            ...
            $('#create').submit(function (event) {
                ...
                $.ajax({
                    type        : 'POST',                               //metodo
                    url         : '<?= asset('direcciones/store') ?>', //controlador
